...
1. Click on `Upload` to upload your "unicef_metadata.csv" file on your RStudio Cloud
...
Save your "unicef_metadata.csv" file under a new name by using the R object name that you previously gave
