...
- Shortcut to pinned Power BI activities
--

- Shortcut to your most recent Power BI activities
--

- The main access to create visualisations and dashboards
--

- List of the data you previously used with their settings
--
...
- Power BI activities that you haven't created but shared with you
--
...
- Collaborative environment to design dashboard (Pro version only)
--

- List of created documents (dashboards, reports, workbooks, and datasets)
...
```{r out.width='80%'}
include_graphics("https://v1.nitrocdn.com/MmRYricBGnwFelNvIykEOHWwZuUwjnwj/assets/static/optimized/rev-169dd29/wp-content/uploads/2019/11/powerbi-diagram.png")
```
...
### Go to: Get Data (Nav. Pane) -> Sample -> "Customer Profitability Sample" 

### Go to: Learn (Nav. Pane) -> "Artificial Intelligence Sample"
...
Note: In Power BI, if you click directly in the empty cell, all the data will be pasted in this cell.
...
# Distribution and Comparison in Power BI
...
---
# Timeseries and Maps in Power BI
...
## From the loop page, use the data in the Titanic.csv file to create a report in Power BI

Remember to use texts and titles to convey your narrative.
