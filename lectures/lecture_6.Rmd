...
`r faa("exclamation-triangle", animate="flash", speed="slow", color="red")` Warning: This is not mandatory for your assignment, only submitting the URL of your dashboard on Loop is.
