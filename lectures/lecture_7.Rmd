...
```{r out.width='100%'}
include_graphics("https://b6d1pk1fu4-flywheel.netdna-ssl.com/wp-content/uploads/2018/10/Adding-a-Sheet-to-a-Tableau-Tooltip-300x188@2x.png")
```
...
.pull-left[
- Adding Highlight Actions to a dashboard is **the easiest way to make it smart**. By choosing "hoover" as interaction mode, the figures will react to the users simultaneously.

- Filter Actions are interesting too but they can be **confusing when hoover or click are chosen** to trigger. Prefer triggering Filter Actions from menus instead.
]
...
# 4. Share your Tableau Dashboard
...
`r faa("exclamation-triangle", animate="flash", speed="slow", color="red")` Warning: If you save as a simple workbook (.twb file extension), it won't be accepted.

--

#### Sharing is the process of publishing a dashboard online for everyone to access it.

- It is done with an account to **Tableau Online** 
- It can be used in your CV as a portfolio of skills in data visualisation and storytelling

`r faa("arrow-circle-right", animate="horizontal", speed="slow", color="blue")` Note: Sharing your assignment dashboard with **Tableau Online** is an alternative option to submit your assignment
...
Two data files will be emailed to you, focus your dashboard on the file called **unicef_data.csv** and use the file **unicef_metadata.csv** to help developing your story.

**Tell a "story" (i.e., narrative) behind the data in ONE Tableau Dashboard.** The dashboard has to include 3 figures: 1 Distribution, 1 Comparison, and 1 Relationship figure. Maps and timeseries figures can be used to support 1 or more of the 3 requested figures.
...
### Coming Soon: EDHEC DataViz Challenge (2022) https://www.edhec.edu/en/student-dataviz-challenge-2022
